sap.ui.define(
  ...
  (
    ...
    return BaseController.extend('sap.ui.time.mvc.controller.rewardVacationReport.Main', {
      initializeModel() {
        return {
        ...
        try {
          ...
          if (!this.FormDialog) {
            ...
            this.FormDialog = await Fragment.load({
              id: oView.getId(),
              name: 'sap.ui.time.mvc.view.rewardVacationReport.fragment.FormDialog',
              controller: this,
            });
      ...
      async initializePopover() {
        ...
        this._Popover = await Fragment.load({
          id: oView.getId(),
          name: 'sap.ui.time.mvc.view.rewardVacationReport.fragment.FormPopover',
          controller: this,
        });
